...
from gym_pybullet_drones.envs.BaseAviary import BaseAviary, DroneModel, Physics, ActionType, ObservationType, ImageType
...
class BaseRLAviary(BaseAviary):
    ...
    def _actionSpace(self):
        ...
        if self.ACT_TYPE in [ActionType.RPM, ActionType.VEL]:
            size = 4
        elif self.ACT_TYPE in [ActionType.PID, ActionType.URP]:
            size = 3
