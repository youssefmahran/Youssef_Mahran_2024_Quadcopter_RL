...
############### INSTALLATION ###############
- Open a new terminal
- Create a new virtual environment: "conda create -n baselines python=3.6"
- Activate the virtual environment: "conda activate baselines"
...
Open TD3_Small_Space_Result.py, TD3_Large_Space_Result.py, SAC_Small_Space_Result.py and SAC_Large_Space_Result.py found in "Codes" folder and add the path of "gym_pybullet_drones" folder to line 5. 
For example: "sys.path.append('/path/to/Youssef_Mahran_2024_Quadcopter_RL/RPM_Controller/gym-pybullet-drones-1.0.0')"
