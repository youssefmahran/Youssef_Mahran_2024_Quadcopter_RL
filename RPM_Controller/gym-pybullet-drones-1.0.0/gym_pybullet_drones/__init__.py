...
register(
    id='rl-agent-v0',
    entry_point='gym_pybullet_drones.envs.single_agent_rl:ControlRL',
)

register(
    id='rldis-agent-v0',
    entry_point='gym_pybullet_drones.envs.single_agent_rl:ControlDiscrete',
)

register(
    id='rl-agent-v1',
    entry_point='gym_pybullet_drones.envs.single_agent_rl:ControlRL2',
)
