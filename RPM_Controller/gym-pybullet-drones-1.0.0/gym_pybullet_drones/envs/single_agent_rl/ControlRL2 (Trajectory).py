...
class ControlRL2(BaseSingleAgentAviary):
    ...
    def __init__(self,
        ...
        path = 'C:/Users/eta1/Desktop/Mazen/Bachelor/bachelor-thesis-main/bachelor-thesis-main/env-mod/traj.csv'
    ...
    def _computeDone(self):
        if self.waypoint == 100 or self._boundingboxCollision() or self._isUpright():
